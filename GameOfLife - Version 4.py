...
class GameOfLife:
    ...
    def check_cell_neighbors(self, row_index, col_index):
        #Implement 4 rules, too populated, underpoulated, death, birth.
        ...
        if self.grids[self.active_grid][row_index][col_index] == 0 and num_alive_neighbors == 3:  # if the cell is dead, and he has 3 neighbors, it comes to live.
            return 1
        if num_alive_neighbors > 4:
            return 0 #it dies of overpopulation
        elif num_alive_neighbors < 3:
            return 0 #it dies of underpopulation
        if ( num_alive_neighbors == 3 or num_alive_neighbors == 4 ) and self.grids[self.active_grid][row_index][col_index] == 1:  #If there are 3 or 4 neighbors, and the cell is alive, it stays alive.
            return 1
        else:
            return 0
    ...
    def run(self):
        desired_milliseconds_between_updates = (1.0 / 1.0) * 1000.0  #Max microseconds for a framerate of 60hz, .0 so you get floating.
        while True:
